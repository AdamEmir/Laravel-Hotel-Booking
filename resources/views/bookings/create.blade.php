            ...
            <div class="form-group">
                <div class="container-sm rounded p-4" style="border: 2px solid #adb5bd">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Full Name: </strong><input type="text" name="guest_name" class="form-control"
                    ...
                    <div class="row align-items-start">
                        <div class="col-6">
                            <strong>Check In: </strong><input type="date" name="check_in" class="form-control"
                                placeholder="Check In" />
                        </div>
                        <div class="col-6">
                            <strong>Check Out: </strong><input type="date" name="check_out" class="form-control"
