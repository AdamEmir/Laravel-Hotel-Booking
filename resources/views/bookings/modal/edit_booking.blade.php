<div class="modal fade" id="bookingEditModal{{ $booking->id }}" tabindex="-1" role="dialog"
    aria-labelledby="bookingEditModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/kemaskini/{{ $booking->id }}" method="POST">
                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <select class="form-select" name="employee_id" id="employee_id"
                                                ...
                                                <option value="{{ $booking->employee_id }}">
                                                    {{ $booking->employee_id }}</option>
                                ...
                                <div class="col-sm-8 order-2">
                                    ...
                                    <div class="col-sm-8 order-3">
                                        <input type="text" name="employee_name" class="form-control"
                                            placeholder="Employee Name" value="{{ $booking->employee_name }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="container-sm rounded p-4" style="border: 2px solid #adb5bd">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <strong>Email: </strong><input type="email" name="email"
                                            class="form-control" placeholder="Email" value="{{ $booking->email }}" />
                                    </div>
                                </div>
                                <br />
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" style="height: 150px" name="remarks_questions" placeholder="Remarks/Questions">{{ $booking->remarks_questions }}</textarea>
                                    </div>
                                </div>
                                <br />
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" style="height: 150px" name="damage_remarks" placeholder="Damage Remarks">{{ $booking->damage_remarks }}</textarea>
                                    </div>
                                </div>
                                <br />
                                <div class="col-xs-12 col-sm-12 col-md-12">
