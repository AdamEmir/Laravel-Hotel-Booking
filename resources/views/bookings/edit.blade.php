                ...
                <div class="row">
                    <div class="col-sm-4 order-1">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <select class="form-select" name="employee_id" id="employee_id" class="room-select"
                                    aria-label="Default select example" value="{{ $booking->employee_id }}">
                    ...
                    <div class="col-sm-8 order-2">
                        ...
                        <div class="col-sm-8 order-3">
                            <input type="text" name="employee_name" value="{{ $booking->employee_name }}"
                ...
                <div class="container-sm rounded p-4" style="border: 2px solid #adb5bd">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Full Name: </strong><input type="text" name="guest_name"
                                value="{{ $booking->guest_name }}" class="form-control" placeholder="Full Name" />
                        </div>
                    </div>
                    <br />
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Phone Number: </strong><input type="text" name="phone_number"
                                value="{{ $booking->phone_number }}" class="form-control" placeholder="Phone Number" />
                        </div>
                    </div>
                    <br />
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Email: </strong><input type="email" name="email" value="{{ $booking->email }}"
                    ...
                    <div class="row align-items-start">
                        <div class="col-6">
                            <strong>Check In: </strong><input type="date" name="check_in"
                                value="{{ $booking->check_in }}" class="form-control" placeholder="Check In" />
                        </div>
                        <div class="col-6">
                            <strong>Check Out: </strong><input type="date" name="check_out"
                                value="{{ $booking->check_out }}" class="form-control" placeholder="Check Out" />
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            <strong>Guest Number: </strong><input type="number" name="guest_number"
                                value="{{ $booking->guest_number }}" class="form-control" placeholder="Guest Number" />
                        </div>
                    </div>
                    <br />
                    <div class="row justify-content-lefts">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select class="form-select" name="room_type" id="room_type"
                                    value="{{ $booking->room_type }}" class="room-select"
                        ...
                        <div class="col-sm-5 order-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-1 order-3">
                                    <input type="checkbox" name="dinner_buffet" id="dinner_buffet" value="yes"
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" style="height: 150px" value="{{ $booking->remarks_questions }}"
                                name="remarks_questions" placeholder="Remarks/Questions"></textarea>
                        </div>
                    </div>
                    <br />
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" style="height: 150px" value="{{ $booking->damage_remarks }}" name="damage_remarks"
                                placeholder="Damage Remarks"></textarea>
                        </div>
                    </div>
                    <br />
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" name="total_fine" value="{{ $booking->total_fine }}"
