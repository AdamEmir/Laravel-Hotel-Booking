    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/tempah/simpan" method="POST">
                    @csrf
                    @method('POST')
                    <div class="col-xl">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="date" value="" id="check_in"
                                                name="check_in" />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="check_out" class="col-md-2 col-form-label">Check
                                            Out</label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="date" value="" id="check_out"
                                                name="check_out" />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="col-md-10">
                                            <input class="form-control" type="number" value="1"
                                                id="guest_number" name="guest_number" />
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">Remarks /
                                            Questions</label>
                                        <textarea class="form-control" id="remarks_questions" name="remarks_questions" rows="3"></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">Damage
                                            Remarks</label>
                                        <textarea class="form-control" id="damage_remarks" name="damage_remarks" rows="3"></textarea>
                                    </div>
                                    <div class="mb-5">
